...
public class CustomArrayAdapterProductes extends ArrayAdapter<Producte> {
    LayoutInflater layoutInflater;
    List<Producte> llistaProductes;

    public CustomArrayAdapterProductes(Context context, List<Producte>productes){
        ...
        holder.getCheckBox().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (llistaProductes.get(position).getSelected()) {
                    message = llistaProductes.get(position).getNom() + " unselected";
                    ...
                    message = llistaProductes.get(position).getNom() + " selected";
        ...
        holder.getButtonMes().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cbProduct.isChecked()) {
                    ...
                    tvQuantitat.setText(String.valueOf(MainActivity.llistaProductes.get(position).getQuantitat()));
                }
            }
        });
